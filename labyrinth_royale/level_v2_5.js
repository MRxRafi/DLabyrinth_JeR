...
DLabyrinth.levelState.prototype = {
    preload: function() {
        ...
        //Mapa
        game.load.tilemap('mapa', 'assets/map/MapaTiledJson.Json', null, Phaser.Tilemap.TILED_JSON);
        //game.load.tilemap('mapa', 'assets/map/MapaTiledCSV_Capa de Patrones 1.csv', null, Phaser.Tilemap.CSV);
        //game.load.tilemap('mapa2', 'assets/map/MapaTiledCSV_Capa de Patrones 2.csv', null, Phaser.Tilemap.CSV);
...
function Interface(){
    ...
    this.createInterface = function(){
        ...
        //Dimensiones de cada tile: 32 x 32
        //Dimensiones del minimapa: 150 x 150 = 22500
        ...
        game.miniMap = game.add.sprite(625, 350, miniMapBmd);
        game.miniMap.fixedToCamera = true;
        game.miniMap.cameraOffset.setTo(600, 400);
