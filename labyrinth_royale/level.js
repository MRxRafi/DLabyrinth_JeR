...
DLabyrinth.levelState.prototype = {
	...
	/////////////////////////// INTERFAZ ///////////////////////////
        ...
        /*
        //Armas por el mapa
        var g = new WeaponItem(100, 200, 'pistol', 1, 500, 10, 'pistola');
        var h = new WeaponItem(100, 100,'ak-47', 0.25, 200, 30, 'metralleta');
        weaponItems.push(g);
        weaponItems.push(h);

        //Munición por el mapa
        var a = new AmmoItem(100, 500, 'ak47_ammo', 30, 'metralleta');
        var a1 = new AmmoItem(100, 600, 'pistol_ammo', 10, 'pistola');
        ammoItems.push(a);
        ammoItems.push(a1);
        ...
        //Comida por el mapa
        var f = new FoodItem(500, 500, 'food');
        var f1 = new FoodItem(500, 600, 'food');
        foodItems.push(f);
        foodItems.push(f1);
        */
       generateItems();
